      ...
      <header className="toolbar">
        ...
        <div className="controls">
          ...
          <div className="algorithms">
            ...
            <button onClick={() => runAlgorithm(getMergeSortAnimations, MERGE_SORT_CODE)}>Merge Sort</button>
            <button onClick={() => runAlgorithm(getQuickSortAnimations, QUICK_SORT_CODE)}>Quick Sort</button>
          </div>
        </div>
      </header>
